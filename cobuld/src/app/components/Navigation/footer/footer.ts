...
export class Footer {
  ...
  socialLinks: SocialLink[] = [
    {
      label: 'Facebook',
      url: 'https://www.facebook.com/cobludhealthtech',
      svgPath:
